                ...
                <div class="ibox float-e-margins">
                   ...
                   <form:form method="POST" commandName="storage" class="form-horizontal" >
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Tên Nơi Lưu Trữ</label>
                                     <form:hidden path="idStorage" />
                                    <div class="col-sm-10">
                                        <form:input type="text" path="nameStoragel" required="true" class="form-control"/>
                                    </div>
                                </div>
